...
import com.coolwhite.instaclone_1.databinding.FragmentUserBinding;
...
//        ((MainActivity) getActivity()).getBinding().p
    ...
    private class UserRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
